...
export default function View() {
  ...
  return (
    <div className="p-8 pb-0 ">
      ...
      <div className="grid grid-cols-12 items-center justify-between w-full p-12 mt-6 bg-[#6941C6] rounded-lg">
        ...
        <Card className="col-span-6">
          <CardContent>
            <div className="order-first md:order-last flex flex-col gap-4 p-6 w-full items-center">
              <h1 className="flex flex-row gap-2 items-baseline text-neutral-500">เวลาปัจจุบัน</h1>
