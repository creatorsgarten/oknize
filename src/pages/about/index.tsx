...
const About = () => {
  return (
    <div>
      <Navbar />
      <div>
        <div className="flex flex-col justify-center items-center gap-8 text-xl mx-auto max-w-3xl pt-8 p-4 lg:p-16 lg:pb-0">
          <h1 className="text-3xl px-4 font-semibold">
        ...
        <div className="flex flex-col justify-center items-center gap-8 text-xl mx-auto max-w-3xl p-6 pt-10 lg:p-16 lg:pb-4">
          ...
          <p>
            Step 1: ควบคุม Agenda ภายในวันงานให้สามารถใช้งานได้แบบ Dynamic
            เมื่อมีการเปลี่ยนแปลงสล็อตเวลาของ Task นั้นๆ - ฐานข้อมูลอีเวนต์
            ให้จัดการได้แบบง่ายๆ (เราอยู่ที่นี่)
          </p>
          <p>
            Step 2: - เพิ่มการแจ้งเตือนให้กับ User เมื่อมีการเปลี่ยนแปลง Task
            ให้สตาฟที่เข้ามาในระบบแล้ว -
            เพิ่มรายละเอียดการตั้งค่าอีเวนต์ตอนเริ่มงาน - ระบบจัดการสตาฟ
          </p>
          <p>
            Step 3: - สร้างเทมเพลตเอกสารพร้อมใช้งาน เช่น เอกสารการใช้งานสถานที่
            หรือ การทำบิล - วิเคราะห์ข้อมูลหลังจบงาน - เทมเพลตอีเวนต์ -
